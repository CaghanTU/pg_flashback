...
SELECT flashback_restore('public.order_items', :'disaster_timestamp'::timestamptz) AS restored_items;
SELECT flashback_restore('public.orders', :'disaster_timestamp'::timestamptz) AS restored_orders;
