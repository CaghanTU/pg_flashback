...
BEGIN
    ...
    WITH allowed(grantee, signature) AS (
        VALUES
            ...
            ('flashback_recovery_agent', 'public.flashback_install_verified_backup_proof(text,bigint,text,text,text,text,numeric,bigint,text,text,pg_lsn,pg_lsn,timestamp with time zone,jsonb)'),
            ('flashback_recovery_agent', 'public.flashback_install_verified_wal_frontier_proof(text,bigint,bigint,text,text,text,bigint,pg_lsn,text,timestamp with time zone,jsonb)'),
