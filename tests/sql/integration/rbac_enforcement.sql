...
BEGIN
    ...
    WITH allowed(grantee, signature) AS (
        VALUES
            ...
            ('flashback_admin', 'public.flashback_local_restore_preflight_snapshot(bigint,bigint)'),
            ...
            ('flashback_admin', 'public.flashback_measure_external_snapshot_capacity(regclass)'),
            ('flashback_admin', 'public.flashback_admit_external_snapshot_capacity(regclass)'),
            ('flashback_admin', 'public.flashback_advise(regclass)'),
            ('flashback_admin', 'public.flashback_config_recommend(regclass,text)'),
            ('flashback_admin', 'public.flashback_local_compatibility(regclass)'),
            ('flashback_admin', 'public.flashback_local_compatibility_schema_def(jsonb)'),
            ('flashback_admin', 'public.flashback_resolve_lifecycle_name(text)'),
            ('flashback_admin', 'public.flashback_is_actively_protected(text)'),
            ('flashback_admin', 'public.flashback_lifecycle_health(text)'),
            ('flashback_admin', 'public.flashback_operation_state(bigint)'),
            ('flashback_admin', 'public.flashback_maintain_plan(text)'),
            ('flashback_admin', 'public.flashback_maintain_execute(text)'),
            ('flashback_admin', 'public.flashback_maintain_begin(text)'),
            ('flashback_admin', 'public.flashback_maintain_finalize(bigint)'),
            ('flashback_admin', 'public.flashback_maintain_external_copy(bigint)'),
            ('flashback_admin', 'public.flashback_maintain_external_publish(bigint)'),
            ('flashback_admin', 'public.flashback_protect_begin(text)'),
            ('flashback_admin', 'public.flashback_protect_prepare_replica_identity(bigint)'),
            ('flashback_admin', 'public.flashback_protect_external_copy(bigint)'),
            ('flashback_admin', 'public.flashback_protect_external_publish(bigint)'),
            ('flashback_admin', 'public.flashback_protect_finalize(bigint)'),
            ('flashback_admin', 'public.flashback_protect_next_action(bigint)'),
            ('flashback_admin', 'public.flashback_protect_find_resumable(text)'),
            ('flashback_admin', 'public.flashback_protect_abort(bigint)'),
            ('flashback_admin', 'public.flashback_reconcile_protect_operations(integer)'),
            ('flashback_admin', 'public.flashback_storage_budget_policy()'),
            ('flashback_admin', 'public.flashback_lifecycle_storage_metrics(text)'),
            ('flashback_admin', 'public.flashback_prepare_uninstall(boolean)'),
            ...
            ('flashback_admin', 'public.flashback_external_filesystem_available_bytes()'),
